...
public class TaskExcel01 {
    public static void main(String[] args) throws IOException {
        ...
        //HSSFWorkBook - xlsx <2004

        //Task1 - Create a Excel File and Add Data
        Map<String, Object> data = new TreeMap<>();
        data.put("1", new Object[]{"LoginId", "Email", "Password"});
        data.put("2", new Object[]{"1", "nayan@live.com", "pwd@123"});
        data.put("3", new Object[]{"2", "test@gmail.com", "test@123"});
